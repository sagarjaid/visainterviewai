...
const GDPR = () => {
  return (
    <>
      <SEOMeta
        title='GDPR Policy — visainterviewai'
      ...
      <main className='m-auto flex h-screen max-w-5xl flex-col'>
        <div className='flex flex-col items-start justify-center gap-6 px-4 py-10 '>
          ...
          <p>
            At visainterviewai, accessible from https://visainterviewai.com/,
            one of our main priorities is the privacy of our visitors. This
            Privacy Policy document contains types of information that is
            collected and recorded by visainterviewai and how we use it.
          </p>
          <h2>General Data Protection Regulation (GDPR)</h2>
          <p>We are a Data Controller of your information.</p>
          <p>
            visainterviewai legal basis for collecting and using the personal
          ...
          <ul>
            <li>visainterviewai needs to perform a contract with you</li>
            <li>You have given visainterviewai permission to do so</li>
            <li>
              Processing your personal information is in visainterviewai
              legitimate interests
            </li>
            <li>visainterviewai needs to comply with the law</li>
          </ul>
          <p>
            visainterviewai will retain your personal information only for as
          ...
          <p>
            Like any other website, visainterviewai uses "cookies". These
          ...
          <p>
            ...
            advertising partners of visainterviewai.
          </p>
          <p>
            Third-party ad servers or ad networks uses technologies like
            cookies, JavaScript, or Web Beacons that are used in their
            respective advertisements and links that appear on visainterviewai,
          ...
          <p>
            Note that visainterviewai has no access to or control over these
            cookies that are used by third-party advertisers.
          </p>
          <h2>Third Party Privacy Policies</h2>
          <p>
            visainterviewai's Privacy Policy does not apply to other advertisers
          ...
          <p>
            visainterviewai does not knowingly collect any Personal Identifiable
          ...
          <p>
            ...
            that they shared and/or collect in visainterviewai. This policy is
