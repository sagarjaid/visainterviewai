...
const Interviewx = () => {
  ...
  return (
    <div className='flex sdm:flex-row flex-col p-4 gap-4 rounded-xl h-fit'>
      <div className='border sdm:w-[600px] w-full flex flex-col h-fit rounded-lg shadow-md bg-white'>
        ...
        <div className='flex flex-col sdm:flex-row gap-4 justify-between p-4'>
          <div
            className='h-36 border outline-none rounded-md w-full p-2 text-xs text-gray-400'
          ...
          <div className='flex flex-col gap-4 justify-between'>
            <div className='bg-gray-100 p-1.5 px-2 text-red-500 font-semibold rounded-md text-xs'>
              0:00/1:00
            </div>
      ...
      <div className='w-full sdm:w-fit flex sdm:flex-col gap-3  '>
        <div className='flex flex-col gap-2 w-full h-full sdm:w-60 sdm:h-44 border rounded-md shadow-sm p-3 bg-white'>
        ...
        <div className='hidden sdm:flex items-center gap-3.5 text-sm '>
          <div className='px-3.5 py-1 w-20 text-center border bg-gray-100 cursor-pointer shadow-sm rounded-md'>
            Previous
          </div>
          <div className='px-3.5 py-1 bg-gray-500 text-center text-white cursor-pointer w-fit shadow-sm rounded-full'>
            <Image
              src='/end-call.svg'
              width={22}
              height={22}
      ...
      <div className='flex justify-center mt-4 sdm:hidden items-center gap-3.5 text-sm '>
        <div className='px-3.5 py-1 w-20 text-center border bg-gray-100 cursor-pointer shadow-sm rounded-md'>
          Previous
        </div>
        <div className='px-3.5 py-1 bg-gray-500 text-center text-white cursor-pointer w-fit shadow-sm rounded-full'>
